...
class Cryptlight_Elementor_Card_Token extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Card Token', 'cryptlight' );
	}
            ...
            [
                ...
                'default' 	=> [
                    [	
                        ...
                        'title' => esc_html__( 'Mobile payment make easy','cryptlight' ),
                        'desc' 	=> esc_html__( "There's no need to sign up, you can use a mobile device to pay with the most simple steps",'cryptlight' ),
                    ],
                    [	
                    	'image' => [ 'url' => Elementor\Utils::get_placeholder_image_src(), ],
                        'title' => esc_html__( 'No transaction fee','cryptlight' ),
                        'desc' 	=> esc_html__( 'You can buy tokens how much you want without paying any transaction fee for our system','cryptlight' ),
                    ],
                    [	
                    	'image' => [ 'url' => Elementor\Utils::get_placeholder_image_src(), ],
                        'title' => esc_html__( 'Protect the identity','cryptlight' ),
                        'desc' 	=> esc_html__( 'If we detect a potential threat to your identity, we will alert you by text, email, phone or app','cryptlight' ),
                    ],
                    [	
                    	'image' => [ 'url' => Elementor\Utils::get_placeholder_image_src(), ],
                        'title' => esc_html__( 'Security and control over money','cryptlight' ),
                        'desc' 	=> esc_html__( 'We can provide high levels of security that allows the user to keep control over their money','cryptlight' ),
                    ],
                ],
                'title_field' => '{{{ title }}}',
            ]
